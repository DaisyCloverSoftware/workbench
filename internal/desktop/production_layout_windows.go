...
func (s *Shell) layoutProductionSettings(x, y, width, height int) {
	...
	moveWindow(s.controls[idMCPStatus], x+4, top+296, left-8, 34)
	moveWindow(s.controls[idCopyMCP], x+4, top+338, 174, 32)
	moveWindow(s.controls[idRunnerLabel], x+4, top+386, left-8, 20)
	moveWindow(s.controls[idRunnerHost], x+4, top+410, left-8, 30)
	moveWindow(s.controls[idHarnessLabel], x+4, top+450, left-8, 20)
	moveWindow(s.controls[idHarnessCommand], x+4, top+474, left-8, 30)
	moveWindow(s.controls[idNotifyLabel], x+4, top+514, left-8, 20)
	moveWindow(s.controls[idNotifyCommand], x+4, top+538, left-8, 30)
	moveWindow(s.controls[idSaveRouting], x+4, top+580, 176, 32)
